...
export class PackagesComponent implements OnInit {
  colors: string[] =[ '#f1f4f9', '#d4dfed', '#c6d4e7', '#a9bfda', '#8da9ce', '#436a9d', '#2b4464', '#182739', '#0c131d' ]
  ...
  constructor( private _packages: InvestmentService, private _modalService: BsModalService,
    ...
    this.packageForm = this._formBuilder.group({
      ...
      Amount: [{value:'', disabled: true}, [Validators.required, Validators.min(50)]],
  ...
  deposit() {
    ...
    if(this.packageForm.valid) {
      ...
      this._depositService.makeDeposit(deposit)
